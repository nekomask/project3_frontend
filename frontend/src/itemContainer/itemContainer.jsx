...
const ItemContainer = () => {
    ...
    const deleteItem = async (idToDelete) => {
        ...
        try {
            const apiResponse = await fetch(`https://my-bike-database-backend.herokuapp.com/${idToDelete}`, {
                method: "DELETE"
            })
            const parsedResponse = await apiResponse.json()
            if (parsedResponse.success) {
    ...
    const getItems = async () => {
        try {
            const items = await fetch("https://my-bike-database-backend.herokuapp.com/")
    ...
    const updateItem = async (idToUpdate, itemToUpdate) => {
        ...
        const apiResponse = await fetch(`https://my-bike-database-backend.herokuapp.com/${idToUpdate}`, {
            method: "PUT",
